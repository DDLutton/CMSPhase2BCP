...
#include "../src/algo_unpacked_DCLRps_NojR.h"
#include "TPG.hh"
#include "../data/LUT.h"
...
#pragma HLS UNROLL
		...
		output_word.range(145,128) = reg[lnk][1].shift_reg[3];
		output_word.range(166,148) = reg[lnk][1].peak_reg[0];
		output_word.range(186,168) = reg[lnk][1].peak_reg[1];
