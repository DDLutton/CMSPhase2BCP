...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module algo_unpacked_coedEe_rom (
...
initial begin
    $readmemh("./algo_unpacked_coedEe_rom.dat", ram0);
    $readmemh("./algo_unpacked_coedEe_rom.dat", ram1);
    $readmemh("./algo_unpacked_coedEe_rom.dat", ram2);
    $readmemh("./algo_unpacked_coedEe_rom.dat", ram3);
    $readmemh("./algo_unpacked_coedEe_rom.dat", ram4);
    $readmemh("./algo_unpacked_coedEe_rom.dat", ram5);
    $readmemh("./algo_unpacked_coedEe_rom.dat", ram6);
    $readmemh("./algo_unpacked_coedEe_rom.dat", ram7);
end
...
parameter AddressRange = 32'd570;
...
algo_unpacked_coedEe_rom algo_unpacked_coedEe_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
