...
set out_width 21
set exp i0*i1
set arg_lists {i0 {13 1 +} i1 {8 0 +} p {21 1 +} acc {0} }
set TrueReset 0
...
set out_width 25
set exp i0*i1
set arg_lists {i0 {7 1 +} i1 {18 0 +} p {25 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
...
eval "cg_default_interface_gen_dc { \
    id 12 \
    name r_1_peak_reg_V_read \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_r_1_peak_reg_V_read \
    op interface \
    ports { r_1_peak_reg_V_read { I 19 vector } } \
} "
}
