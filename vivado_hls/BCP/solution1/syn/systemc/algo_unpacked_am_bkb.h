...
#ifndef __algo_unpacked_am_bkb__HH__
#define __algo_unpacked_am_bkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(algo_unpacked_am_bkb) {
    ...
    SC_CTOR(algo_unpacked_am_bkb):  simcore_am_0_U ("simcore_am_0_U") {
