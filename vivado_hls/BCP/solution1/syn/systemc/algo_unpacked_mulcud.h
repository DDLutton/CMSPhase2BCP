...
#ifndef __algo_unpacked_mulcud__HH__
#define __algo_unpacked_mulcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(algo_unpacked_mulcud) {
    ...
    SC_CTOR(algo_unpacked_mulcud):  ACMP_smul_su_U ("ACMP_smul_su_U") {
